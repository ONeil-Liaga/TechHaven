                  ...
                  <div class="row">
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <input type="text" name="postcode" placeholder="Postcode" class="form-control" value="<?php echo e(Request::get('postcode')); ?>">
                          </div>
                      </div>
                  ...
                  <tbody>
                    <?php $__currentLoopData = $getRecord; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr>
                      ...
                      <td>
                          <select class="form-control ChangeStatus" id="<?php echo e($value->id); ?>" style="width: 150px;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\TechHub\resources\views/admin/order/list.blade.php ENDPATH**/ ?>