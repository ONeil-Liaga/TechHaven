...
<?php $__env->startSection('content'); ?>
        ...
        <main class="main">
            <div class="page-header text-center" style="background-image: url('<?php echo e(url('')); ?>/assets/images/page-header-bg.jpg')">
                <div class="container">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <?php if(!empty($getSubCategory)): ?>
                            <li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(url($getCategory->slug)); ?>"><?php echo e($getCategory->name); ?></a></li>
                            ...
                            <div class="toolbox">
                                <div class="toolbox-left">
                                    <div class="toolbox-info">
                                        Showing <span><?php echo e($getProduct->perPage()); ?> of <?php echo e($getProduct->total()); ?></span> Products
                                    ...
                                    <div class="collapse show" id="widget-3">
                                        <div class="widget-body">
                                            <div class="filter-colors">
                                                ...
                                                <a href="javascript:;" id="<?php echo e($f_color->id); ?>" class="ChangeColor" data-val="0" style="background: <?php echo e($f_color->code); ?>;"><span class="sr-only"><?php echo e($f_color->name); ?></span></a>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                                
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\TechHub\resources\views/product/list.blade.php ENDPATH**/ ?>